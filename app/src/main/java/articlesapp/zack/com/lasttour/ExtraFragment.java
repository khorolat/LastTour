...
public class ExtraFragment extends Fragment {
    ...
    private ListAdapter ExtraAdapter;
    FirebaseStorage storage = FirebaseStorage.getInstance();
    StorageReference storageRef ;
    DatabaseReference db;
    StorageReference firebaseStorage;
    FirebaseHelperExtra helper;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lvExtra = (ListView) v.findViewById(R.id.lvExtra);

        pd = new ProgressDialog(getActivity());
        pd.setMessage("Uploading....");
        db = FirebaseDatabase.getInstance().getReference();
        firebaseStorage = FirebaseStorage.getInstance().getReference().child("toursoweto_photos");
        FloatingActionButton floatingActionButton = (FloatingActionButton) v.findViewById(R.id.floatingActionButtonextra);
        helper = new FirebaseHelperExtra(db);


        adapter = new ExtraAdapter(getActivity(), helper.retrive());
...
//                startActivityForResult(intent,GALLERY_INTENT);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                extra.setUrl(pojoUri);
                if (name != null && name.length() > 0) {
                    if (helper.save(extra)) {
