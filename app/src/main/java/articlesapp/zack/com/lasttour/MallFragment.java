...
public class MallFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lvMall = (ListView) v.findViewById(R.id.lvMall);

        pd = new ProgressDialog(getActivity());
        pd.setMessage("Uploading....");
        db = FirebaseDatabase.getInstance().getReference();
        firebaseStorage = FirebaseStorage.getInstance().getReference().child("toursoweto_photos");
        FloatingActionButton floatingActionButton = (FloatingActionButton) v.findViewById(R.id.floatingActionButtonmall);
        helper = new FirebaseHelper(db);


        adapter = new MallAdapter(getActivity(), helper.retrive());
